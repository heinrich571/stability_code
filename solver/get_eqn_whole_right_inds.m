function i_eqn_R = get_eqn_whole_right_inds(equation_name, Nx, Ny)

% DESCRIPTION
%   This function returns the indices of the specified equation at the whole right side of the domain in the eigenvalue problem matrices.
% INPUT:
...
% OUTPUT:
%   j_var_L             column index of specified equation at the whole right side of the domain in the eigenvalue problem matrices  [scalar]
...
i_eqn_R  = (i_eqn_TR - 1) + ((jm * Ny) + 1 : Nx * Ny);
