function j_var_R = get_var_whole_right_inds(variable_name, Nx, Ny)

% DESCRIPTION
%   This function returns the indices of the specified variable at the whole right side of the domain in the eigenvalue problem matrices.
% INPUT:
...
% OUTPUT:
%   j_var_R             column index of specified variable at the whole right side of the domain in the eigenvalue problem matrices  [scalar]
...
j_var_R  = (j_var_TR - 1) + ((jm * Ny) + 1 : Nx * Ny);
