function [Solution_Filtered, Solution_Raw] = biglobalsolver_old(mat_A, mat_B, Domain)
...
nrm = max(Solution_Raw.p(:,inds), [], 1);

Solution_Filtered.omega = Solution_Raw.omega(inds);
Solution_Filtered.u = Solution_Raw.u(:,inds)./nrm;
Solution_Filtered.v = Solution_Raw.v(:,inds)./nrm;
Solution_Filtered.w = Solution_Raw.w(:,inds)./nrm;
Solution_Filtered.p = Solution_Raw.p(:,inds)./nrm;
