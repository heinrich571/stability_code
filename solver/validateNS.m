...
Report.Error.Continuity = reshape(Absolute_Error(0*Nx*Ny+1:1*Nx*Ny,:), Ny, Nx, N_eigenvalues);
Report.Error.X_Momentum = reshape(Absolute_Error(1*Nx*Ny+1:2*Nx*Ny,:), Ny, Nx, N_eigenvalues);
Report.Error.Y_Momentum = reshape(Absolute_Error(2*Nx*Ny+1:3*Nx*Ny,:), Ny, Nx, N_eigenvalues);
Report.Error.Z_Momentum = reshape(Absolute_Error(3*Nx*Ny+1:4*Nx*Ny,:), Ny, Nx, N_eigenvalues);
